...
final currentpagepos = GlobalKey<CarouselState>();
      ...
      body: new Stack(
        children: <Widget>[
          ...
          widget.showIndicator ? new Positioned(
            ...
            child: new Container(
              decoration: new BoxDecoration(
                color:Colors.transparent,// widget.dotBgColor == null ? Colors.grey[800].withOpacity(0.5) : widget.dotBgColor,

...
import 'package:imageswipe/pages/dob_cupertino_picker.dart';
...
*/
const ShapeBorder zShape = const RoundedRectangleBorder(
...
class DatePicker extends StatefulWidget {
  DatePicker({
    ...
    this.customIcon = Icons.check_circle,
    this.fromYear,
    this.toYear,
    this.initialYear,
  }) : super(key: key);
...
class DatePickerState extends State<DatePicker> {
  ...
  int get dobYear =>  _initialYear-(100-_selectedYear);
  String get dobStrMonth => _dobMonth;

  @override
  void initState() {
    int _toYear = widget.toYear??_date.year+1;
    super.initState();
